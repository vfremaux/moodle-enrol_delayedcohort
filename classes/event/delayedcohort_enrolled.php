...
/**
 * Event fired when a delayedcohort is effectively enrolled.
 *
...
class delayedcohort_enrolled extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_delayedcohort_enrolled', 'enrol_delayedcohort');
    }
    ...
    public function get_description() {
        return "the programmmed delayed cohort enrol '$this->objectid' has been activated. ";
    }
