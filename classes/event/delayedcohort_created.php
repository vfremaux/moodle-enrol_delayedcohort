...
/**
 * This file contains an event for when a delayed cohort inqtance is added to a course.
 *
 ...
 * }
 */
class delayedcohort_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_delayedcohort_created', 'enrol_delayedcohort');
    }
