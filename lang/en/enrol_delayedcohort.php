...
$string['enrolenddate_help'] = 'If not defined, enrolled users will remain enrolled event after legal end date is reached.';
$string['enrolstartdate'] = 'Enrol Start date';
$string['enrolstartdate_help'] = 'If not defined, this is equivalent to the standard cohort enrolment plugin of Moodle';
...
$string['groupidnumber_help'] = "Care at the unicity of the group idnumber";
$string['groupname'] = 'Group name';
$string['grouppropmode'] = 'Group propagation mode';
$string['grouppropmode_help'] = '
    Here you can tel moodle to create a new group from cohort info or using specific naming from the form, 
    or designate an existing group to add enrolled users to when the synchronisation will be triggered.
';
$string['createfromcohort'] = 'Create group from cohort';
$string['createfromform'] = 'Create group using following info';
$string['instanceexists'] = 'Cohort is already synchronised with selected role';
$string['legaldate'] = 'Legal range dates';
$string['legaldate_help'] = 'This date can be printed in documents generated by the PDCertificate plugin. Will default to enrol dates if not defined.';
$string['legalstartdate'] = 'Legal start date of the training (for reporting)';
$string['legalenddate'] = 'Legal end date of the training (for reporting)';
