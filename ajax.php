...
$PAGE->set_url(new moodle_url('/enrol/delayedcohort/ajax.php', array('id' => $id, 'action' => $action)));
...
switch ($action) {
    ...
    case 'getcohorts':
        ...
        $outcome->response = enrol_delayedcohort_search_cohorts($manager, $offset, 25, $search);
